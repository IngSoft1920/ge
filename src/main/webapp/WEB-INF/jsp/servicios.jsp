...
elemento.parentNode.remove();
    ...
    <option value="10">10</option>
        ...
        <textarea placeholder="Descripción del pedido" rows="5" size="15" maxlength="100" name="comentario" style="margin-top:20px"></textarea>
          ...
          <br/><br/>
           <input type="submit" value="Encargar">
</br>
    </input></br>
    </form>
		</div>
...
<ul id="lista">
 ...
 <li>Spa<button onclick='eliminar(this)'> cancelar reserva </button> </li>
  <li>Mesa reservada<button onclick='eliminar(this)'> cancelar reserva </button></li>
  <li>Piscina<button onclick='eliminar(this)'> cancelar reserva </button></li>
